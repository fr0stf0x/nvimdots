...
local plug_map = {
	...
	["v|<leader>r"] = map_cmd(":SnipRun<CR>"):with_noremap():with_silent():with_desc("tool: Run code by range"),
	["n|<leader>r"] = map_cmd(":'<,'>SnipRun<CR>"):with_noremap():with_silent():with_desc("tool: Run code by file"),
	...
	["n|<leader>fz"] = map_cmd("<Cmd> Telescope current_buffer_fuzzy_find <CR>")
		:with_noremap()
		:with_silent()
		:with_desc("find: Word in file"),
